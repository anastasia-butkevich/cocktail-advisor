...
Because I'm short on time I will use similar stack of technologies as I did in Concert ChatApp project, because this task is pretty similar to that one. For LLM API I will use Groq API.
